...
- Non-empty selected or manually entered text remains translatable when MinerU Markdown is absent or incomplete. Validated source and index files enable paper-context translation, image OCR and knowledge preparation; paper-derived background, terminology and external research run incrementally and must never delay a translation request.
